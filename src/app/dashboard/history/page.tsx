...
export default function HistoryPage() {
  ...
  useEffect(() => {
    ...
    if (attempts.length === 0) setLoading(true);
    apiClient
  ...
  return (
    <main className="min-h-screen relative" aria-label="Activity history">
      ...
      <section
        className="container max-w-4xl px-4 py-8 mx-auto relative z-10"
        aria-label="History main content"
      >
